export const portalDefaults = {
  ...
  issues: {
    title: "Issues",
    subtitle: "Track CAD, Build, Code, and Portfolio issues",
    body: "Log issues, attach photos, and track them through to resolution."
  },
  outreaches: {
    title: "Outreaches",
    subtitle: "Log Tech and STEM outreach hours",
    body: "Track outreach events, hours, and photos for the team."
  },
  events: {
    title: "Events",
    subtitle: "Keep upcoming competitions and team events organized",
    body: "Track event dates, locations, notes, and participating team members."
  },
  portfolio: {
    title: "Portfolio",
    subtitle: "Manage the team portfolio and its document versions",
    body: "Download documents, add new versions, and record who is working on each document."
  },
  resources: {
  ...
  sponsorship: {
    ...
    body: "Architechs is powered by the generosity of our sponsors. Their investment funds components, travel, registration fees, and our outreach programs.",
    contactEmail: "viswanathv2@gmail.com"
  },
  feedback: {
    title: "Feedback",
